...
/**
 * Created by 90418 on 2017-05-16.
 */
...
public class RoundProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mMode == STROKE_TEXT) {
            ...
            float textHalfWidth = mPaint.measureText(Integer.toString(value))*0.5f;
            canvas.drawText(Integer.toString(value),center - textHalfWidth, center +textHalfSize,
                    mPaint);
        }
